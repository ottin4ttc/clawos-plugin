 ...
 * 
 * 用法：
 *   clawos open <url>                # 在新 tab 中打开
 *   clawos open <url> --tab current  # 在当前 tab 中打开
 *   clawos open <url> --tab 123      # 在指定 tabId 的 tab 中打开
 */

import { generateId, type Request, type Response } from "@clawos/shared";
