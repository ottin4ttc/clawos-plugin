# Privacy Policy — clawos

**Last updated:** 2026-03-14

## What clawos does

clawos is a browser automation tool that lets AI agents control your Chrome browser via the Chrome DevTools Protocol (CDP). It consists of a CLI, an MCP server, a local HTTP daemon, and a Chrome extension.
...
When you use clawos, the extension may access the following data **locally**:
...
clawos does not share any data with third parties. The extension communicates exclusively with a daemon process running on localhost.

## Open source

clawos is fully open source. You can audit the code at:
https://github.com/ottin4ttc/clawos-plugin

## Contact

For privacy questions, open an issue at:
https://github.com/ottin4ttc/clawos-plugin/issues
